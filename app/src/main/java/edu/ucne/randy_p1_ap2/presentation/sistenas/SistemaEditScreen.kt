...
@Composable
private fun SistemasBodyEditScreenPreview() {
    SistemasBodyEditScreen(
        uiState = Uistate(nombre = "Randy"),
        onNameChange = {},
        onPrecioChange = {},
        onSave = {},
        goBack = {}
